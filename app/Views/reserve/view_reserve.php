...
<body>
<div class="wrapper">
    <?= view('include/view_sidebar', ['active' => $active ?? 'reserve']) ?>
    
    <div class="dashboard-container">
        <h1 class="dash-title">Reserve Equipment</h1>
        <p class="dash-subtitle">Fill out the form below to reserve equipment</p>
        ...
        <div class="content-card" style="background: white; padding: 30px; border-radius: 12px; box-shadow: 0px 3px 8px rgba(0,0,0,0.15); margin-top: 20px;">
            <form action="<?= base_url('reserve/submit') ?>" method="POST" id="reserveForm">
                ...
                <!-- Equipment Selection -->
                <div class="mb-4">
                    <h5 class="mb-3">Equipment to Reserve</h5>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" name="reserve_date" class="form-control" required min="<?= date('Y-m-d') ?>">
                        </div>
                        <div class="col-md-4 mb-3">
